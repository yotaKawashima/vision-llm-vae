"""Module defining logging utilities."""
...
class ConsoleLogger(Logger):
    ...
    def __init__(self) -> None:
        ...
        self.verbosity_map = {"none": 0, "error": 1, "success": 2, "info": 3}
    ...
    def log(
        self, log_type: str, log_color: str, content: str, output_stream=sys.stdout
    ) -> None:
        """
    ...
    def set_verbosity(self, verbosity: str) -> None:
        ...
        if verbosity not in self.verbosity_map:
            raise ValueError(
                '"{0}" is not a valid verbosity level. Must be either "none", error", "success", or "info".'
            )
    ...
    def get_verbosity(self) -> str:
        ...
        reverse_verbosity_map = {
            level: verbosity for (verbosity, level) in self.verbosity_map.items()
        }
