...
# =============================================================================
# SLURM Batch Script for Model Training with Apptainer
# =============================================================================
# Submits a job to SLURM to train a VAE/AE/encoder model (see `config.py`)
# inside an Apptainer container, by running `train.sh`.
#
# Usage: sbatch apptainer_train.sh
# =============================================================================
...
#SBATCH --mem=47G                 # 50G for resnet18 Memory allocation
#SBATCH --time=04:30:00           # 03:30 not enough for ae 
