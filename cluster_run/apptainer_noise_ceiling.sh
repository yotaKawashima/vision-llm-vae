...
# =============================================================================
# SLURM Batch Script for Noise Ceiling Estimation with Apptainer
# =============================================================================
# Submits a job to SLURM to compute the fMRI noise ceiling, inside an
# Apptainer container, by running `noise_ceiling.sh`.
#
# Usage: sbatch apptainer_noise_ceiling.sh
# =============================================================================
...
#SBATCH --job-name=noise              # Job name as shown in queue
#SBATCH --output=noise-ceiling-%j.out # Output file with job ID
#SBATCH --nodes=1                     # Number of compute nodes
#SBATCH --ntasks=1                    # Total number of tasks
#SBATCH --ntasks-per-node=1           # Tasks per node
#SBATCH --cpus-per-task=4             # CPU cores per task
#SBATCH --gres=gpu:a5000:1            # Request 1 GPU
#SBATCH --mem=10G                     # 50G for resnet18 Memory allocation
...
apptainer run --nv \
              ...
              ${SIF} bash /mnt/cluster_run/noise_ceiling.sh
